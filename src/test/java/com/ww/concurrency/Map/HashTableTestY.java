...
public class HashTableTestY {
    ...
    public static Map<Integer,String> hashtable = new Hashtable<>();
    ...
    public void HashtableTest(){
        ...
        try {
            ...
            if(hashtable.size() == requestTotal){
                log.info("Hashtable is thread safe!");
            }else {
                log.info("Hashtable is NOT thread safe!");
            }
